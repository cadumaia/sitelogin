 ...
 <div class="container"  text-align="center">
    ...
    <form onSubmit={onSubmit} class="row justify-content-center" >
        <div className="col-md-6">
            ...
            <input type="text" id = "email" value = {email} onChange={onChange}  class="form-control rounded-pill shadow p-3 mb-3 bg-white rounded mt-2" placeholder="Insira o email" />
            </div>
            <div class="form-group row mb-3">
